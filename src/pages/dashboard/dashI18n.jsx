...
const STRINGS = {
  ...
  'pd.doctorNotes': { en: "Doctor's Notes", hi: 'डॉक्टर की टिप्पणियाँ', ta: 'மருத்துவர் குறிப்புகள்' },
  'pd.editNotes': { en: 'Edit notes', hi: 'टिप्पणियाँ संपादित करें', ta: 'குறிப்புகளைத் திருத்து' },
  'pd.addNotes': { en: '+ Add notes', hi: '+ टिप्पणी जोड़ें', ta: '+ குறிப்பு சேர்' },
  'pd.noNotes': {
    en: 'No notes yet for this patient — add clinical observations here.',
    hi: 'इस मरीज़ के लिए अभी कोई टिप्पणी नहीं — यहाँ नैदानिक टिप्पणी जोड़ें।',
    ta: 'இந்த நோயாளிக்கு இன்னும் குறிப்புகள் இல்லை — மருத்துவக் குறிப்புகளை இங்கே சேர்க்கவும்.',
  },
  'pd.notesSub': {
    en: 'Private clinical notes for {name} — visible only to their care team.',
    hi: '{name} के लिए निजी नैदानिक टिप्पणियाँ — केवल देखभाल टीम को दिखेंगी।',
    ta: '{name} க்கான தனிப்பட்ட மருத்துவக் குறிப்புகள் — பராமரிப்புக் குழுவிற்கு மட்டும்.',
  },
  'pd.notesPlaceholder': {
    en: "Observations, response to treatment, anything worth remembering for this patient's next visit…",
    hi: 'अवलोकन, उपचार की प्रतिक्रिया, अगली मुलाकात के लिए याद रखने योग्य कुछ भी…',
    ta: 'கவனிப்புகள், சிகிச்சைக்கான பதில், அடுத்த வருகைக்கு நினைவில் கொள்ள வேண்டியவை…',
  },
